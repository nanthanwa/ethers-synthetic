...
contract DoppleToken is ERC20("Dopple Token", "DOP"), Ownable {
    ...
    function canUnlockAmount(address _account) public view returns (uint256) {
        ...
        // some DOPPLEs can be released
            ...
            uint256 releasedBlock =
                block.number.sub(_lastUnlockBlock[_account]);
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "DOPPLE::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "DOPPLE::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "DOPPLE::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "DOPPLE::_writeCheckpoint: block number exceeds 32 bits"
            );
