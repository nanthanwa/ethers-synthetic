module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    let tx;
    tx = await synthetic.setPairsToAddress('TSLA/USD', result.address, { from: deployer });
    console.log('setPairsToAddress: hash', tx.hash);
    tx = await synthetic.setAddressToPairs(result.address, 'TSLA/USD', { from: deployer });
    console.log('setAddressToPairs: hash', tx.hash);
    tx = await synthetic.setPairsToQuote('TSLA/USD', ['TSLA', 'USD'], { from: deployer });
